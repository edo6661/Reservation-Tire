                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input type="tel" 
                                           ...
                                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors duration-200 @error('phone_number') border-red-500 @enderror"
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="bg-gray-50 rounded-lg p-4">
                                    ...
                                    <div class="space-y-2 text-sm">
                                        ...
                                        <div class="flex items-center justify-between">
                                            <span class="text-gray-600">Total Reservasi:</span>
                                            <span class="font-medium">{{ $customer?->reservations->count() ?? 0 }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
